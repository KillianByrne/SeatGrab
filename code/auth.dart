...
class AuthService {
  ...
  void updateUserData1(FirebaseUser user) async {
    ...
    Firestore.instance.collection('users').document(user.uid).collection('planner').document("newplan")
        .setData({'Name of Module': 'You can add your Module name ',
        ...
        .then((onValue)
    {
      print('Created it in sub collection');
        ...
        .catchError((e) {
      print('The sub collection wasnt added for this reason: ' + e);}
      );
  }
